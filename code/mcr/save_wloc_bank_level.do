...
/* Bank-level variables */
	...
	gen mtm_assets = assets - mtm_2022_loss_level;
	gen ins_dep_cov_ratio = (mtm_assets - deposits + 0.5 * unins_deposits) /
		(deposits - unins_deposits);
	gen large = (assets >= 2e8) if !missing(assets);
	gen branch_density_2022_large = branch_density_2022 * large;
...
/* Quantile dummies */
	foreach var of varlist unins_leverage branch_density_2022 mtm_2022_loss_pct_equity {;
